...
function sendNetworkLog(
    ...
    target,
    info) {
  var formid = "e/1FAIpQLSf8_-hgPI9_fOm1Hk7tm9UycFZkoJatQH_7UqfFUTfJlPKsNA";
  var data = {
    "entry.1513507370": uid,
    "entry.1008060990": time,
    "entry.1684138001": eventname,
    "entry.1265216674": target,
    "entry.1948861596": info
  };
  var params = [];
  for (key in data) {
